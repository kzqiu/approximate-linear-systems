...
class PCG:
    ...
    def line_search_strong_wolfe_conditions(self, f, grad_f, x, d, alpha_init=0.5, c1=1e-4, c2=0.1, max_iter=20, tol=1e-10):
        """
        Perform a line search to find the alpha that satisfies the Strong Wolfe conditions.
        ...
        - d: The search direction.
        - alpha_init: Initial guess for alpha.
        - c1, c2: Constants for the Strong Wolfe conditions.
        - max_iter: Maximum number of iterations to prevent infinite loops.
        - tol: Tolerance for considering Wolfe conditions met, addressing numerical precision issues.

        Returns:
        - alpha: Step size that satisfies the Strong Wolfe conditions or comes within a tolerance of satisfying.
        """
        alpha = alpha_init
        alpha_prev = 0
        iter_count = 0  # Initialize iteration counter
